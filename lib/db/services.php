...
$functions = array(
    ...
    'core_course_submit_module_editing_form' => array(
        'classname'   => 'core_course_external',
        'methodname'  => 'submit_module_editing_form',
        'classpath'   => 'course/externallib.php',
        'description' => 'submit course module editing form and return submission result',
        'type'        => 'write',
        'ajax'        => true,
    ),
    'core_course_submit_module_adding_form' => array(
        'classname'   => 'core_course_external',
        'methodname'  => 'submit_module_adding_form',
        'classpath'   => 'course/externallib.php',
        'description' => 'submit course module  adding form and return submission result',
        'type'        => 'write',
        'ajax'        => true,
    ),
    'core_course_get_course_module_adding_dialog' => array(
        'classname'   => 'core_course_external',
        'methodname'  => 'get_course_module_adding_dialog',
        'classpath'   => 'course/externallib.php',
        'description' => 'get dialog to add resource/activity',
        'type'        => 'read',
        'ajax'        => true,
    ),
    'core_course_get_course_module_editing_dialog' => array(
        'classname'   => 'core_course_external',
        'methodname'  => 'get_course_module_editing_dialog',
        'classpath'   => 'course/externallib.php',
        'description' => 'get dialog to edit resource/activity',
        'type'        => 'read',
        'ajax'        => true,
    ),
